...
pg_url = "postgresql+pg8000://{}:{}@{}:{}/{}".format("jitsu_dev", "rash4z4m!", "165.227.70.211", 5432, pg_file_name)
...
# Create message
def create_message(gmessage_id, gmessage_date, gmessage_from, gmessage_to,
                   gmessage_subject, gmessage_has_attachments, gmessage_raw):
    message_1 = Message(
